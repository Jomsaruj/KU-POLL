...
class QuestionModelTests(TestCase):
    ...
    def test_is_published_with_future_question(self):
        """
        is_published() return False if current date is on or
    ...
    def test_can_vote_with_expired_question(self):
        ...
        endtime = timezone.now() - datetime.timedelta(hours=23, minutes=59, seconds=59)
        question_tester = Question(pub_date=pubtime, end_date=endtime)
...
def create_question(question_text, days, end_date=30):
    ...
    * copy comment from tutorial
    ...
    ending_time = publish_time + datetime.timedelta(days=end_date)  # add ending date
    return Question.objects.create(question_text=question_text, pub_date=publish_time, end_date=ending_time)
